#!/usr/bin/env bash
#
# 4010-tool-ssh-server.sh — optional OpenSSH server for remote access.
#
# Lifecycle:
...
#   * Root login disabled
#   * PermitRootLogin no
#   * Port forced to 22 inside container (published on generated SSH_PORT on all host interfaces)
#
# Usage:
