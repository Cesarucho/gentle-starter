#!/usr/bin/env bash
#
# 2080-browser-playwright.sh — Playwright + chromium browser installer.
#
# Installs both:
...
#
# Opt in with: task install:enable -- 2080-browser-playwright
set -euo pipefail
...
devcontainer_require_cmd npm "Enable 2000-runtime-node.sh before Playwright." || exit 1
devcontainer_require_cmd npx "Enable 2000-runtime-node.sh before Playwright." || exit 1
