#!/usr/bin/env bash
#
# 3020-ai-gentle-ai.sh — install the Gentle AI CLI from its official GitHub release.
#
...
: "${GENTLE_AI_VERSION:=${LOCK_GENTLE_AI_VERSION:?missing LOCK_GENTLE_AI_VERSION}}"
: "${GENTLE_AI_SHA256_AMD64=${LOCK_GENTLE_AI_SHA256_AMD64:?missing LOCK_GENTLE_AI_SHA256_AMD64}}"
: "${GENTLE_AI_SHA256_ARM64=${LOCK_GENTLE_AI_SHA256_ARM64:?missing LOCK_GENTLE_AI_SHA256_ARM64}}"
