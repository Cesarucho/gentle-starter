#!/usr/bin/env bash
#
# 2030-tool-devcontainer-cli.sh — install the devcontainer CLI.
#
...
devcontainer_require_cmd npm "Enable 2000-runtime-node.sh before the Dev Container CLI." || exit 1
