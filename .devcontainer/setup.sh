...
DEVCONTAINER_PHASE=runtime ${PWD}/.devcontainer/scripts/09-install-ai-pi-gentle.sh
DEVCONTAINER_PHASE=runtime ${PWD}/.devcontainer/scripts/10-install-ai-engram.sh
